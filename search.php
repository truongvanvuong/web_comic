                    ...
                    <div class="home-product ">
                       ...
                       ?>
                        <div class="search__heading">
                           <h2 class="search__heading-title">
                            Từ khóa : <?php echo $tukhoa ?>
                           </h2>
                       </div>
                        <div class="grid__row">
                           <?php
                            ...
                            <div class="grid__column-2-4">
                                <a class="home-product-item" href="details.php?proid=<?php echo $result['productId'] ?>">
                                ...
                                <?php
                                        ...
                                        echo '<span class="title">Sản Phẩm Không Tồn Tại</span>';
                                    }
                                ?>
                        </div>
                    </div>
