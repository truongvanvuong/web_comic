                            ...
                            <div class="grid__column-2-4">
                                <a class="home-product-item" href="viewproduct.php?proid=<?php echo $result_new['productId'] ?>">
                                    ...
                                    <div class="home-product__price">
                                        <span class="home-product__price-old"><?php echo $result_new['listed_price'].""."đ" ?></span>
                                    ...
                                    <div class="home-product-item__origin">
                                        <span class="home-product-item__brand"><?php echo $result_new['brandName'] ?></span>
                                        <span class="home-product-item__origin--name"><?php echo $result_new['catName'] ?></span>
                                    </div>
