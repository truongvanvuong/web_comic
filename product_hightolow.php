...
<div class="container">
        <div class="grid">
            ...
            <div class="grid__row app__conten">
                ...
                <div class="grid__column-10 home-product">
                    <div class="home-filter">
                        <span class="home-filter__label">
                            Sắp xếp theo
                        </span>
                        <button class="btn home-filter__btn disabled">Phổ Biến</button>
                        <button class="btn home-filter__btn disabled">Mới nhất</button>
                        <!-- <button class="btn home-filter__btn">Bán chạy</button> -->
                        <div class="select-input">
                            <span class="select-input__label">Từ cao đến thấp</span>
                    ...
                    <div class="home-product-tall ">
                        <div class="grid__row">
                                <?php
                                $product = $product->show_product_thap();
                                if($product){
